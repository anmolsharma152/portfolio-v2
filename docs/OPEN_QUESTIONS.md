...
### Context
In Obsidian Design's portfolio, the Home page (`/`) features two side-by-side cultural shelves:
...
- **Why this works**:
  - Retains 1-to-1 visual parity with obsidian's records shelf layout.
