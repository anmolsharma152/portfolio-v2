...
**Date**: 2026-09-05  
**Current Branch**: `feature/obsidian-inspired-refactor`  
**Latest Commit**: `6dfaed4` (`feat(ui): update nav items to About/Work/Timeline/Contact and implement large obsidian portrait showcase card in About`)  
...
2. **Big obsidian-Style Portrait Showcase Card (`src/components/About.tsx`)**:
...
4. **Hero Typography Scale-Up & Atmospheric Glow (`src/components/Hero.tsx`)**:
   ...
   - Added top obsidian micro-metadata strip: `[ 00 / SYSTEM INITIALIZED ]`, `LOC: JAIPUR, IN // 26.9124° N, 75.7873° E`, and live `<WorkClock /> IST`.
...
4. **Infused obsidian Visual Design & Typography**:
...
1. **Keep Branch Isolation**: All work must continue on `feature/obsidian-inspired-refactor`. Never merge to `main` without explicit user sign-off.
