...
Features a dark retro-futuristic aesthetic inspired by [Obsidian Design](https://obsidian.me), with Google's `Doto` dot-matrix typography, physical frosted glassmorphism, an interactive floating dock navigation, and decoupled JSON content management.
