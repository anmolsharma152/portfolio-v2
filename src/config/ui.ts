...
export const textStyles = {
  ...
  accentLabel:
    'font-mono text-[0.58rem] uppercase tracking-[0.2em] text-white/70 sm:text-[0.62rem] sm:tracking-[0.28em]',
};

export const surfaces = {
  workHeader:
    'relative isolate overflow-hidden rounded-[2rem] bg-white/[0.045] p-5 shadow-[0_28px_100px_rgba(0,0,0,0.50),inset_0_1px_0_rgba(255,255,255,0.14)] ring-1 ring-white/12 backdrop-blur-2xl motion-safe:animate-glass-breathe motion-safe:[animation-delay:-1.1s] motion-safe:[animation-duration:12.5s] sm:p-7 lg:rounded-[2.5rem] lg:p-9',
  workPanel:
    'relative isolate overflow-hidden rounded-[2rem] bg-white/[0.04] p-5 shadow-[0_24px_90px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.12)] ring-1 ring-white/10 backdrop-blur-2xl motion-safe:animate-glass-breathe sm:p-6 lg:rounded-[2.5rem]',
  reachPanel:
    'relative isolate overflow-hidden rounded-[2.5rem] bg-white/[0.04] p-5 shadow-[0_30px_120px_rgba(0,0,0,0.50),inset_0_1px_0_rgba(255,255,255,0.14)] ring-1 ring-white/12 backdrop-blur-2xl motion-safe:animate-glass-breathe sm:p-7',
  reachOutPanel:
    'relative isolate overflow-hidden rounded-[2.5rem] bg-white/[0.04] p-5 shadow-[0_30px_120px_rgba(0,0,0,0.50),inset_0_1px_0_rgba(255,255,255,0.14)] ring-1 ring-white/12 backdrop-blur-2xl motion-safe:animate-glass-breathe motion-safe:[animation-delay:-4.9s] motion-safe:[animation-duration:13.8s] sm:p-7 lg:p-8',
};
