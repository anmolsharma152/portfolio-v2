        ...
        <AnimatePresence mode="popLayout">
          {filteredBooks.map((book: BookItem) => (
            <motion.article
              ...
              className={`relative min-h-[9.5rem] overflow-hidden rounded-xl p-3.5 shadow-md ring-1 transition-all duration-300 hover:scale-[1.02] flex flex-col justify-between ${book.toneGradient}`}
            >
              ...
              <div className="relative flex items-start gap-3">
                {/* Book cover image */}
                <div className="relative h-24 w-16 flex-none overflow-hidden rounded-md bg-black/40 shadow-md ring-1 ring-white/20">
                  {book.coverIsbn ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center text-[0.6rem] font-mono uppercase tracking-widest text-white/50 text-center p-1">
                ...
                <div className="flex min-w-0 flex-1 flex-col justify-between self-stretch py-0.5">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-white/70 line-clamp-1">{book.authors.join(', ')}</p>
                  </div>

                  {book.takeaway && (
                    <p className="text-[0.72rem] text-white/80 line-clamp-2 italic mt-2 border-l border-white/20 pl-2">
              ...
              {/* Card Footer */}
              <div className="mt-3 flex items-center justify-between gap-2 border-t border-white/15 pt-2 font-mono text-[0.62rem] uppercase tracking-wider text-white/60">
