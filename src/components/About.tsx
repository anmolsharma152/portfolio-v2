...
const About = () => {
  ...
  return (
    <section id="about" className="py-16 md:py-24 relative z-10 isolate overflow-hidden">
      {/* Background ambient lighting & obsidian dot-matrix raster */}
      <div
        aria-hidden="true"
      ...
      <div className="max-w-[1460px] mx-auto px-4 sm:px-8 lg:px-10">
        {/* Dedicated About Header Card (Matches obsidian aboutHeader 1-to-1) */}
        ...
        >
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[minmax(0,1.15fr)_minmax(22rem,0.85fr)] gap-8 lg:gap-10 items-stretch">
            ...
            <div className="flex min-w-0 flex-col justify-center">
              {/* Minimalist Profile Pills (obsidian Style) */}
        ...
        {/* 2-Column Side-by-Side Shelves (obsidian Style: Playlists Left, Books Right) */}
