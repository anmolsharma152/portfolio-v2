  ...
  return (
    <section id="about" className="py-20 md:py-28 relative z-10">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12">
        {/* Section Header with obsidian Metadata Row */}
        ...
        {/* Main Showcase: Big obsidian-Style 2-Column Split (Story & Capabilities Left | Big Portrait Right) */}
        <motion.div
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-8 xl:gap-12 items-stretch">
            ...
            {/* Right Column: Big obsidian-Style Framed Portrait Showcase */}
