      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
        {reachMetricsContent.map((metric, idx) => (
          ...
          >
            <div
              aria-hidden="true"
              className="pointer-events-none absolute inset-0 -z-10 opacity-50 [background:radial-gradient(circle_at_20%_20%,rgba(255,255,255,.07),transparent_40%),radial-gradient(circle_at_80%_80%,rgba(255,255,255,.03),transparent_45%)]"
            />
