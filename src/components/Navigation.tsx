...
export const Navigation: React.FC = () => {
  ...
  // Exact 5 icons and classes from portfolio SOCIAL_ICON_CLASS_MAP (Image 2)
  ...
  // Auto-hide dock while scrolling down, reappear on scroll stop or top (portfolio parity)
  useEffect(() => {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto relative max-w-[calc(100vw-1rem)] overflow-hidden rounded-full border border-white/14 bg-[rgba(10,12,17,0.42)] p-1 shadow-nav-glass backdrop-blur-2xl sm:max-w-full sm:p-1.5">
        {/* Physical 3D Glass Specular Highlight from portfolio */}
        <span
          aria-hidden="true"
